import{C as e,F as t,L as n,N as r,O as i,a,b as o,c as s,d as c,f as l,h as u,i as d,j as f,l as p,n as m,o as h,r as g,s as _,t as v,u as y,v as b,w as x,y as S}from"./index-D63sPFoN.js";import{n as C}from"./utils-BZltm_RL.js";import{s as w,t as T,u as E}from"./query-engine-Bm0lT-qI.js";var D=Object.create,O=Object.defineProperty,k=Object.getOwnPropertyDescriptor,A=Object.getOwnPropertyNames,j=Object.getPrototypeOf,M=Object.prototype.hasOwnProperty,N=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),P=(e,t,n,r)=>{if(t&&typeof t==`object`||typeof t==`function`)for(var i=A(t),a=0,o=i.length,s;a<o;a++)s=i[a],!M.call(e,s)&&s!==n&&O(e,s,{get:(e=>t[e]).bind(null,s),enumerable:!(r=k(t,s))||r.enumerable});return e},F=(e,t,n)=>(n=e==null?{}:D(j(e)),P(t||!e||!e.__esModule?O(n,`default`,{value:e,enumerable:!0}):n,e)),I=[`#ef4444`,`#f97316`,`#f59e0b`,`#eab308`,`#10b981`,`#14b8a6`,`#3b82f6`,`#6366f1`,`#8b5cf6`,`#ec4899`,`#64748b`,`#d97706`];function L(e){return e.players.some(e=>e.round_scores.some(e=>e.phase!==void 0))?`phase10`:`rounds`}function R(e){let t=new Map;for(let n of e.players)for(let e of n.round_scores)t.has(e.round_number)||t.set(e.round_number,e.round_name);let n=[...t.entries()].sort((e,t)=>e[0]-t[0]);if(!n.every(([e,t])=>t===String(e)))return n.map(([,e])=>e)}function z(e,t,n){let r=e.players.filter(e=>e.is_winner);if(r.length===0)return;if(r.length===1)return t.get(r[0].name.trim().toLowerCase());let i=n===`phase10`||n===`low`?r.reduce((e,t)=>e.final_score<t.final_score?e:t):r.reduce((e,t)=>e.final_score>t.final_score?e:t);return t.get(i.name.trim().toLowerCase())}async function B(e){if(!e.game_name||!e.date_played||!Array.isArray(e.players)||e.players.length===0)throw Error(`Invalid format: missing game_name, date_played, or players`);let t=L(e),n=R(e),r=Date.now(),i;return await S.transaction(`rw`,[S.players,S.games,S.gameNights,S.matches,S.scoreEntries],async()=>{let a=[],o=await S.players.toArray(),s=new Map(o.map(e=>[e.displayName.trim().toLowerCase(),e.id])),c=new Map;for(let t of e.players){let e=t.name.trim().toLowerCase();if(s.has(e))c.set(e,s.get(e));else{let n=(o.length+a.length)%I.length,i=await S.players.add({displayName:t.name.trim(),color:I[n],active:!0,createdAt:r});c.set(e,i),a.push(t.name.trim())}}let l=await S.games.toArray(),u=e.game_name.trim().toLowerCase(),d=l.find(e=>e.name.trim().toLowerCase()===u),f;if(d)f=d.id;else{let i={name:e.game_name.trim(),scoringMode:t,createdAt:r};n&&(i.roundLabels=n),f=await S.games.add(i)}let p=await S.gameNights.add({title:e.game_name.trim(),date:e.date_played,createdAt:r}),m=e.players.map(e=>c.get(e.name.trim().toLowerCase())),h=z(e,c,t),g=await S.matches.add({gameNightId:p,gameId:f,playerIds:m,status:e.is_complete?`completed`:`active`,winnerId:h,createdAt:r}),_=[];for(let n of e.players){let e=c.get(n.name.trim().toLowerCase());for(let i of n.round_scores){let n={matchId:g,playerId:e,roundNumber:i.round_number,value:i.round_score,createdAt:r};t===`phase10`&&i.phase!==void 0&&(n.note=JSON.stringify({phase:i.phase,completed:!!i.phase_completed})),_.push(n)}}await S.scoreEntries.bulkAdd(_);let v=Math.max(...e.players.flatMap(e=>e.round_scores.map(e=>e.round_number)));i={gameName:e.game_name.trim(),date:e.date_played,playerCount:e.players.length,newPlayers:a,roundCount:v}}),window.dispatchEvent(new CustomEvent(`scorekeeper:datachanged`)),i}var V=`scorekeeper_sync_config`;function H(){try{let e=localStorage.getItem(V);if(!e)return null;let t=JSON.parse(e);return t.provider||=`github`,t}catch{return null}}function U(e){localStorage.setItem(V,JSON.stringify(e))}function W(e){return(e.baseUrl??``).replace(/\/+$/,``)}function G(e){return e.provider===`gitea`?`${W(e)}/api/v1/repos/${e.username}/${e.repo}/contents/${e.filePath}`:`https://api.github.com/repos/${e.username}/${e.repo}/contents/${e.filePath}`}function K(e){return e.provider===`gitea`?`${W(e)}/api/v1/repos/${e.username}/${e.repo}`:`https://api.github.com/repos/${e.username}/${e.repo}`}function q(e){let t={Authorization:`token ${e.pat}`,"Content-Type":`application/json`};return e.provider===`github`&&(t.Accept=`application/vnd.github.v3+json`),t}function J(e){return e.provider===`gitea`?`Gitea`:`GitHub`}function Y(e,t){let n=t===`gitea`?`Gitea`:`GitHub`;switch(e){case 401:return`Unauthorized – check your ${t===`gitea`?`API key`:`Personal Access Token`}`;case 403:return`Forbidden – token may lack repo write permissions`;case 404:return`Not Found – check username, repo name, and file path`;case 409:return`Conflict – file was modified remotely; try syncing from ${n} first`;case 422:return`Unprocessable – invalid request data`;case 429:return`Rate Limited – too many requests, try again in a minute`;default:return`${n} API error (HTTP ${e})`}}function X(e){return e.username?e.repo?e.pat?e.provider===`gitea`&&!e.baseUrl?`Base URL is required for Gitea`:null:e.provider===`gitea`?`API key is required`:`Personal Access Token is required`:`Repository name is required`:`Username is required`}async function Z(e){try{let t=await fetch(K(e),{headers:q(e)});if(t.ok){let n=await t.json();return{ok:!0,message:`Connected to ${n.full_name??`${e.username}/${n.name??e.repo}`} on ${J(e)}`}}return{ok:!1,message:Y(t.status,e.provider)}}catch(e){return{ok:!1,message:`Network error: ${e instanceof Error?e.message:String(e)}`}}}async function Q(e){try{let t=await x(),n=JSON.stringify(t,null,2),r=btoa(unescape(encodeURIComponent(n))),i=G(e),a=q(e),o,s=await fetch(`${i}?ref=${encodeURIComponent(e.branch)}`,{headers:a});if(s.ok)o=(await s.json()).sha;else if(s.status!==404)return{ok:!1,message:Y(s.status,e.provider)};let c={message:`Scorekeeper sync ${new Date().toISOString()}`,content:r,branch:e.branch};o&&(c.sha=o);let l=await fetch(i,{method:`PUT`,headers:a,body:JSON.stringify(c)});return l.ok?(U({...e,lastSync:Date.now()}),{ok:!0,message:`Synced to ${J(e)} successfully`}):{ok:!1,message:Y(l.status,e.provider)}}catch(e){return{ok:!1,message:`Sync error: ${e instanceof Error?e.message:String(e)}`}}}async function $(e,t){try{let n=`${G(e)}?ref=${encodeURIComponent(e.branch)}`,i=await fetch(n,{headers:q(e)});if(!i.ok)return{ok:!1,message:Y(i.status,e.provider)};let a=await i.json(),o=decodeURIComponent(escape(atob(a.content.replace(/\n/g,``)))),s=JSON.parse(o),c=await x();return(c.players.length>0||c.gameNights.length>0||c.matches.length>0)&&!await t()?{ok:!1,message:`Sync cancelled`}:(await r(s),U({...e,lastSync:Date.now()}),{ok:!0,message:`Synced from ${J(e)} successfully`})}catch(e){return{ok:!1,message:`Sync error: ${e instanceof Error?e.message:String(e)}`}}}var ee=class{players=[];games=[];syncConfig=null;roomConfig=null;editingPlayerId=null;editingGameId=null;activeTab=`players`;fieldConfig=w();async load(){let[e,t]=await Promise.all([f(),i()]);this.players=e,this.games=t,this.syncConfig=H(),this.roomConfig=d(),this.fieldConfig=w()}formatTimestamp(e){return e?new Date(e).toLocaleString():`Never`}render(){let e=(document.documentElement.getAttribute(`data-theme`)??`dark`)!==`light`,t=this.activeTab,n=e=>e===t?``:`style="display:none"`;return`
      <main class="view" aria-label="Settings">
        ...
        <!-- Players tab -->
        <div id="settings-tab-players" role="tabpanel" ${n(`players`)}>
        ...
        <!-- Games tab -->
        <div id="settings-tab-games" role="tabpanel" ${n(`games`)}>
        ...
        <!-- Sync tab -->
        <div id="settings-tab-sync" role="tabpanel" ${n(`sync`)}>
              ...
              <form id="sync-form" novalidate>
                ...
                <div class="form-group" id="sync-baseurl-group" style="display:${this.syncConfig?.provider===`gitea`?`block`:`none`}">
                  ...
                  <input class="form-input" type="url" id="sync-baseurl"
                    ...
                    value="${this.syncConfig?.baseUrl?C(this.syncConfig.baseUrl):``}" />
                ...
                <div class="form-row">
                  <div class="form-group">
                    ...
                    <input class="form-input" type="text" id="sync-username" placeholder="octocat" autocomplete="off"
                      value="${this.syncConfig?C(this.syncConfig.username):``}" />
                  </div>
                  <div class="form-group">
                    ...
                    <input class="form-input" type="text" id="sync-repo" placeholder="my-scores" autocomplete="off"
                      value="${this.syncConfig?C(this.syncConfig.repo):``}" />
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <input class="form-input" type="password" id="sync-pat"
                    ...
                    autocomplete="off" value="${this.syncConfig?C(this.syncConfig.pat):``}" />
                ...
                <div class="form-row">
                  <div class="form-group">
                    ...
                    <input class="form-input" type="text" id="sync-filepath" placeholder="scorekeeper.json"
                      value="${this.syncConfig?C(this.syncConfig.filePath):`scorekeeper.json`}" />
                  </div>
                  <div class="form-group">
                    <label class="form-label" for="sync-branch">Branch</label>
                    <input class="form-input" type="text" id="sync-branch" placeholder="main"
                      value="${this.syncConfig?C(this.syncConfig.branch):`main`}" />
                  </div>
                </div>
        ...
        <!-- Data tab -->
        <div id="settings-tab-data" role="tabpanel" ${n(`data`)}>
            ...
            <div class="card">
              <div class="text-sm" style="display:flex;flex-direction:column;gap:0.4rem">
                ...
                <div class="flex items-center gap-2">
                  ...
                  <span class="font-semibold">${new Date(`2026-06-10T04:01:16.352Z`).toLocaleString()}</span>
                </div>
              </div>
            </div>
          </section>
        ...
        <!-- Stats Fields tab -->
        <div id="settings-tab-stats" role="tabpanel" ${n(`stats`)}>
          ${this.renderStatsFieldsTab()}
        </div>

        <div style="height:1rem"></div>
      </main>
    `}renderStatsFieldsTab(){let e=this.fieldConfig,t=e.builtinOrder.map((t,n)=>{let r=T.find(e=>e.key===t);if(!r)return``;let i=e.builtinEnabled[t]!==!1;return`
        <div class="sf-row" data-field-key="${C(t)}">
          <label class="toggle sf-toggle" aria-label="Enable ${C(r.label)}">
            <input type="checkbox" class="sf-builtin-toggle" data-field-key="${C(t)}" ${i?`checked`:``} role="switch">
            <span class="toggle-slider"></span>
          </label>
          <span class="sf-label ${i?``:`text-muted`}">${C(r.label)}</span>
          <span class="sf-type-pill">${r.type}</span>
          <div class="sf-reorder">
            <button class="btn btn-icon btn-sm sf-up" data-field-key="${C(t)}" ${n===0?`disabled`:``} aria-label="Move up">↑</button>
            <button class="btn btn-icon btn-sm sf-down" data-field-key="${C(t)}" ${n===e.builtinOrder.length-1?`disabled`:``} aria-label="Move down">↓</button>
          </div>
        </div>`}).join(``),n=e.customFields.map(e=>`
      <div class="sf-row sf-custom-row">
        <span class="sf-label">${C(e.label)}</span>
        <span class="sf-type-pill">${e.type}</span>
        <code class="sf-expr text-muted">${C(e.expression)}</code>
        <div class="sf-reorder">
          <button class="btn btn-sm btn-secondary sf-edit-custom" data-custom-id="${C(e.id)}" style="font-size:0.75rem;padding:2px 8px">Edit</button>
          <button class="btn btn-sm btn-danger sf-del-custom" data-custom-id="${C(e.id)}" style="font-size:0.75rem;padding:2px 8px">✕</button>
        </div>
      </div>`).join(``);return`
      <section class="settings-section" aria-labelledby="sf-builtin-heading">
        ...
        <div class="card sf-list" id="sf-builtin-list">
          ${t||`<p class="text-sm text-muted" style="padding:0.5rem">No built-in fields found.</p>`}
        </div>
      </section>
      ...
      <section class="settings-section" aria-labelledby="sf-custom-heading">
        ...
        <div class="card sf-list mb-2" id="sf-custom-list">
          ${n||`<p class="text-sm text-muted" style="padding:0.5rem 0">No custom fields yet.</p>`}
        </div>
        ...
        <div class="card">
          <div class="toggle-row mb-3">
            <div>
              ...
              <div class="text-sm text-muted font-mono">${C(e.roomId)}</div>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input class="form-input" type="text" id="fb-share-url"
                readonly value="${C(t)}" aria-label="Shareable room link" />
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input class="form-input font-mono" type="text" id="fb-room-id"
                value="${C(e?.roomId??g())}" autocomplete="off"
    ...
    `}renderPlayersList(){return this.players.length===0?`<p class="text-sm text-muted">No players yet. Add one below.</p>`:this.players.map(e=>`
      <div class="player-list-item" data-player-id="${e.id}">
        ...
        <div class="flex-1">
          <div class="font-semibold text-sm">${C(e.displayName)}</div>
          <div class="text-xs text-muted">${e.active?`Active`:`Inactive`}</div>
        </div>
        <div class="actions">
          <button class="btn btn-icon btn-sm edit-player-btn" data-player-id="${e.id}" aria-label="Edit ${C(e.displayName)}">
            ✏️
          </button>
          <button class="btn btn-icon btn-sm delete-player-btn" data-player-id="${e.id}" aria-label="Delete ${C(e.displayName)}">
            🗑️
          </button>
        </div>
      </div>
    `).join(``)}renderPlayerForm(e){let t=e?.displayName??``,n=e?.color??I[0],r=e?.active??!0,i=I.map(e=>`
      ...
      <form id="player-form" novalidate>
        ...
        <div class="form-group">
          ...
          <input class="form-input" type="text" id="player-name" placeholder="e.g. Alice"
            value="${C(t)}" required maxlength="30" autocomplete="off" />
    ...
    `}renderGamesList(){return this.games.length===0?`<p class="text-sm text-muted">No games yet. Add one below.</p>`:this.games.map(e=>`
      <div class="game-list-item" data-game-id="${e.id}">
        ...
        <div class="flex-1">
          <div class="font-semibold text-sm">${C(e.name)}</div>
          <div class="text-xs text-muted">${e.scoringMode} scoring${e.roundLabels?.length?` · ${e.roundLabels.length} round labels`:``}${e.rules?` · `+C(e.rules.substring(0,40)):``}</div>
        </div>
        <div class="actions">
          <button class="btn btn-icon btn-sm edit-game-btn" data-game-id="${e.id}" aria-label="Edit ${C(e.name)}">
            ✏️
          </button>
          <button class="btn btn-icon btn-sm delete-game-btn" data-game-id="${e.id}" aria-label="Delete ${C(e.name)}">
            🗑️
          </button>
        </div>
      </div>
...
`);return`
      <form id="game-form" novalidate>
        ...
        <div class="form-group">
          ...
          <input class="form-input" type="text" id="game-name" placeholder="e.g. Five Crowns"
            value="${C(t)}" required maxlength="50" autocomplete="off" />
        ...
        <div class="form-group">
          ...
          <textarea class="form-textarea" id="game-rules" placeholder="Any rule notes..."
            maxlength="200" rows="2">${C(r)}</textarea>
        </div>
        <div class="form-group">
    ...
    `}afterRender(){document.querySelectorAll(`[data-settings-tab]`).forEach(e=>{e.addEventListener(`click`,()=>{this.activeTab=e.dataset.settingsTab,document.querySelectorAll(`[data-settings-tab]`).forEach(t=>t.classList.toggle(`active`,t===e)),document.querySelectorAll(`[id^="settings-tab-"]`).forEach(e=>{e.style.display=e.id===`settings-tab-${this.activeTab}`?``:`none`})})}),this.bindPlayerForm(),this.bindGameForm(),this.bindFirebaseSection(),this.bindSyncForm(),this.bindDataButtons(),this.bindThemeToggle(),this.bindColorSwatches(),this.bindStatsFields()}_editingCustomId=null;bindStatsFields(){document.querySelectorAll(`.sf-builtin-toggle`).forEach(e=>{e.addEventListener(`change`,()=>{let t=e.dataset.fieldKey;this.fieldConfig.builtinEnabled[t]=e.checked,E(this.fieldConfig),this._refreshStatsTab()})}),document.querySelectorAll(`.sf-up`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.fieldKey,n=this.fieldConfig.builtinOrder.indexOf(t);n>0&&([this.fieldConfig.builtinOrder[n-1],this.fieldConfig.builtinOrder[n]]=[this.fieldConfig.builtinOrder[n],this.fieldConfig.builtinOrder[n-1]],E(this.fieldConfig),this._refreshStatsTab())})}),document.querySelectorAll(`.sf-down`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.fieldKey,n=this.fieldConfig.builtinOrder.indexOf(t);n<this.fieldConfig.builtinOrder.length-1&&([this.fieldConfig.builtinOrder[n],this.fieldConfig.builtinOrder[n+1]]=[this.fieldConfig.builtinOrder[n+1],this.fieldConfig.builtinOrder[n]],E(this.fieldConfig),this._refreshStatsTab())})}),document.querySelectorAll(`.sf-del-custom`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.customId;this.fieldConfig.customFields=this.fieldConfig.customFields.filter(e=>e.id!==t),E(this.fieldConfig),this._refreshStatsTab()})}),document.querySelectorAll(`.sf-edit-custom`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.customId,n=this.fieldConfig.customFields.find(e=>e.id===t);n&&(this._editingCustomId=t,this._showCustomEditor(n.label,n.type,n.expression))})}),document.getElementById(`sf-add-custom-btn`)?.addEventListener(`click`,()=>{this._editingCustomId=null,this._showCustomEditor(``,`boolean`,``)}),document.getElementById(`sf-cf-cancel`)?.addEventListener(`click`,()=>{this._hideCustomEditor()}),document.getElementById(`sf-cf-test`)?.addEventListener(`click`,()=>{let e=document.getElementById(`sf-cf-expr`)?.value??``,t=document.getElementById(`sf-cf-test-result`);if(t)try{let n=Function(`row`,`"use strict"; return (${e});`)({playerCount:4,matchIndexInNight:0,dayOfWeek:5,month:6,year:2025,quarter:2,isWinner:!0,isFirstOut:!1,roundNumber:3,value:42,scoringMode:`high`,gameName:`Catan`,playerName:`Player`,nightDate:`2025-06-01`,matchPlayerIds:[1,2,3,4]});t.innerHTML=`<span style="color:var(--success)">✓ Result on sample row: <strong>${JSON.stringify(n)}</strong></span>`}catch(e){t.innerHTML=`<span style="color:var(--danger)">✗ Error: ${C(String(e))}</span>`}}),document.getElementById(`sf-cf-save`)?.addEventListener(`click`,()=>{let e=document.getElementById(`sf-cf-label`)?.value.trim()??``,t=document.getElementById(`sf-cf-type`)?.value,n=document.getElementById(`sf-cf-expr`)?.value.trim()??``;if(!e){l(`Enter a field name`,`error`);return}if(!n){l(`Enter an expression`,`error`);return}let r=`custom_`+e.toLowerCase().replace(/[^a-z0-9]+/g,`_`).slice(0,30);if(this._editingCustomId){let i=this.fieldConfig.customFields.findIndex(e=>e.id===this._editingCustomId);i!==-1&&(this.fieldConfig.customFields[i]={id:this._editingCustomId,key:r,label:e,type:t,expression:n})}else{let i=`cf-${Date.now()}`;this.fieldConfig.customFields.push({id:i,key:r,label:e,type:t,expression:n})}E(this.fieldConfig),this._editingCustomId=null,this._refreshStatsTab()})}_showCustomEditor(e,t,n){let r=document.getElementById(`sf-custom-editor`);if(!r)return;r.style.display=``,document.getElementById(`sf-cf-label`).value=e,document.getElementById(`sf-cf-type`).value=t,document.getElementById(`sf-cf-expr`).value=n;let i=document.getElementById(`sf-editor-title`);i&&(i.textContent=e?`Edit: ${e}`:`New Custom Field`);let a=document.getElementById(`sf-cf-test-result`);a&&(a.innerHTML=``),r.scrollIntoView({behavior:`smooth`,block:`nearest`})}_hideCustomEditor(){let e=document.getElementById(`sf-custom-editor`);e&&(e.style.display=`none`),this._editingCustomId=null}_refreshStatsTab(){let e=document.getElementById(`settings-tab-stats`);e&&(e.innerHTML=this.renderStatsFieldsTab(),this.bindStatsFields())}bindFirebaseSection(){let e=this.roomConfig,t=h();if(e&&t){document.getElementById(`fb-copy-url-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`fb-share-url`);navigator.clipboard.writeText(e.value).then(()=>{l(`Link copied!`,`success`)}).catch(()=>{e.select(),document.execCommand(`copy`),l(`Link copied!`,`success`)})}),document.getElementById(`fb-show-qr-btn`)?.addEventListener(`click`,async()=>{let t=document.getElementById(`fb-show-qr-btn`),n=document.getElementById(`fb-qr-container`);if(n){if(n.innerHTML){n.innerHTML=``,t.textContent=`Show QR Code`;return}t.textContent=`Generating…`;try{let{default:r}=await c(async()=>{let{default:e}=await import(`./browser-CBbka12M.js`).then(e=>F(e.default,1));return{default:e}},[],import.meta.url),i=v(e);n.innerHTML=await r.toString(i,{type:`svg`,margin:1,width:220}),t.textContent=`Hide QR Code`}catch(e){console.error(`QR generation failed:`,e),t.textContent=`Show QR Code`,l(`QR generation failed`,`error`)}}}),document.getElementById(`fb-push-btn`)?.addEventListener(`click`,async()=>{let e=document.getElementById(`fb-push-btn`);e.disabled=!0,e.textContent=`Pushing…`;try{let e=await s();if(l(e.message,e.ok?`success`:`error`),e.ok){this.roomConfig=d();let e=document.getElementById(`fb-last-sync`);e&&(e.textContent=this.formatTimestamp(this.roomConfig?.lastSync))}}finally{e.disabled=!1,e.textContent=`↑ Push Now`}}),document.getElementById(`fb-pull-btn`)?.addEventListener(`click`,async()=>{let e=document.getElementById(`fb-pull-btn`);e.disabled=!0,e.textContent=`Pulling…`;try{let e=await _();if(l(e.message,e.ok?`success`:`error`),e.ok){this.roomConfig=d();let e=document.getElementById(`fb-last-sync`);e&&(e.textContent=this.formatTimestamp(this.roomConfig?.lastSync))}}finally{e.disabled=!1,e.textContent=`↓ Pull Now`}}),document.getElementById(`fb-disconnect-btn`)?.addEventListener(`click`,()=>{if(!confirm(`Disconnect from live sync? Local data is kept, sync stops.`))return;y(),m(),this.roomConfig=null;let e=document.getElementById(`view-container`);e&&(e.innerHTML=this.render(),this.afterRender()),l(`Disconnected from live sync`,`info`)});return}document.getElementById(`fb-new-room-btn`)?.addEventListener(`click`,()=>{let e=document.getElementById(`fb-room-id`);e&&(e.value=g())});let n=document.getElementById(`fb-config-form`);n&&n.addEventListener(`submit`,async e=>{e.preventDefault();let t=document.getElementById(`fb-room-id`).value.trim();if(!t){l(`Room ID is required`,`error`);return}let n={roomId:t};p(n),this.roomConfig=n;let r=document.getElementById(`fb-connect-btn`);r.disabled=!0,r.textContent=`Connecting…`;try{let e=await a(n,()=>{let e=document.getElementById(`view-container`);e&&(e.innerHTML=this.render(),this.afterRender())});if(e.ok){l(e.message,`success`),this.roomConfig=d();let t=document.getElementById(`view-container`);t&&(t.innerHTML=this.render(),this.afterRender())}else l(e.message,`error`),r.disabled=!1,r.textContent=`Connect & Sync`}catch(e){l(`Connection error: ${e instanceof Error?e.message:String(e)}`,`error`),r.disabled=!1,r.textContent=`Connect & Sync`}})}bindColorSwatches(){document.querySelectorAll(`.color-swatch`).forEach(e=>{let t=()=>{let t=e.dataset.color??``;document.querySelectorAll(`.color-swatch`).forEach(e=>{e.classList.remove(`selected`),e.setAttribute(`aria-selected`,`false`)}),e.classList.add(`selected`),e.setAttribute(`aria-selected`,`true`);let n=document.getElementById(`player-color`);n&&(n.value=t)};e.addEventListener(`click`,t),e.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),t())})})}bindPlayerForm(){document.querySelectorAll(`.edit-player-btn`).forEach(e=>{e.addEventListener(`click`,e=>{let t=parseInt(e.currentTarget.dataset.playerId??``,10);this.editingPlayerId=t;let n=this.players.find(e=>e.id===t),r=document.getElementById(`add-player-form-container`);if(r&&n){let e=r.querySelector(`h3`);e&&(e.textContent=`Edit Player`);let t=r.querySelector(`#player-form`);t&&(t.outerHTML=this.renderPlayerForm(n)),r.innerHTML=`<h3 class="card-title mb-3">Edit Player</h3>${this.renderPlayerForm(n)}`,this.bindColorSwatches(),this.bindPlayerFormSubmit(),document.getElementById(`cancel-edit-player-btn`)?.addEventListener(`click`,()=>{this.editingPlayerId=null,r.innerHTML=`<h3 class="card-title mb-3">Add Player</h3>${this.renderPlayerForm()}`,this.bindColorSwatches(),this.bindPlayerFormSubmit()}),r.scrollIntoView({behavior:`smooth`,block:`nearest`})}})}),document.querySelectorAll(`.delete-player-btn`).forEach(t=>{t.addEventListener(`click`,async t=>{let n=parseInt(t.currentTarget.dataset.playerId??``,10),r=this.players.find(e=>e.id===n);if(r&&confirm(`Delete player "${r.displayName}"? This will not affect existing match records.`))try{await e(n),this.players=this.players.filter(e=>e.id!==n);let t=document.getElementById(`players-list`);t&&(t.innerHTML=this.renderPlayersList()),this.bindPlayerForm(),l(`Player deleted`,`info`)}catch{l(`Failed to delete player`,`error`)}})}),this.bindPlayerFormSubmit()}bindPlayerFormSubmit(){let e=document.getElementById(`player-form`);if(!e)return;let t=e.cloneNode(!0);e.replaceWith(t),this.bindColorSwatches(),t.addEventListener(`submit`,async e=>{e.preventDefault();let t=document.getElementById(`player-name`),r=document.getElementById(`player-color`),i=document.getElementById(`player-active`),a=document.getElementById(`player-editing-id`)?.value,o=document.getElementById(`player-name-error`),s=t.value.trim();if(!s){o&&(o.textContent=`Name is required`),t.focus();return}o&&(o.textContent=``);let c={displayName:s,color:r.value||I[0],active:i.checked,createdAt:Date.now()};try{a?(await n(parseInt(a,10),{displayName:c.displayName,color:c.color,active:c.active}),l(`Player updated`,`success`)):(await b(c),l(`${s} added!`,`success`)),this.players=await f(),this.editingPlayerId=null;let e=document.getElementById(`players-list`);e&&(e.innerHTML=this.renderPlayersList());let t=document.getElementById(`add-player-form-container`);t&&(t.innerHTML=`<h3 class="card-title mb-3">Add Player</h3>${this.renderPlayerForm()}`),this.bindColorSwatches(),this.bindPlayerFormSubmit(),this.bindPlayerForm()}catch(e){console.error(e),l(`Failed to save player`,`error`)}})}bindGameForm(){document.querySelectorAll(`.edit-game-btn`).forEach(e=>{e.addEventListener(`click`,e=>{let t=parseInt(e.currentTarget.dataset.gameId??``,10);this.editingGameId=t;let n=this.games.find(e=>e.id===t),r=document.getElementById(`add-game-form-container`);r&&n&&(r.innerHTML=`<h3 class="card-title mb-3">Edit Game</h3>${this.renderGameForm(n)}`,this.bindGameFormSubmit(),document.getElementById(`cancel-edit-game-btn`)?.addEventListener(`click`,()=>{this.editingGameId=null,r.innerHTML=`<h3 class="card-title mb-3">Add Game</h3>${this.renderGameForm()}`,this.bindGameFormSubmit()}),r.scrollIntoView({behavior:`smooth`,block:`nearest`}))})}),document.querySelectorAll(`.delete-game-btn`).forEach(e=>{e.addEventListener(`click`,async e=>{let t=parseInt(e.currentTarget.dataset.gameId??``,10),n=this.games.find(e=>e.id===t);if(n&&confirm(`Delete game "${n.name}"? This will not affect existing match records.`))try{await o(t),this.games=this.games.filter(e=>e.id!==t);let e=document.getElementById(`games-list`);e&&(e.innerHTML=this.renderGamesList()),this.bindGameForm(),l(`Game deleted`,`info`)}catch{l(`Failed to delete game`,`error`)}})}),this.bindGameFormSubmit()}bindGameFormSubmit(){let e=document.getElementById(`game-form`);if(!e)return;let n=e.cloneNode(!0);e.replaceWith(n),n.addEventListener(`submit`,async e=>{e.preventDefault();let n=document.getElementById(`game-name`),r=document.getElementById(`game-mode`),a=document.getElementById(`game-rules`),o=document.getElementById(`game-target`),s=document.getElementById(`game-round-labels`),c=document.getElementById(`game-editing-id`)?.value,d=document.getElementById(`game-name-error`),f=n.value.trim();if(!f){d&&(d.textContent=`Game name is required`),n.focus();return}d&&(d.textContent=``);let p=s.value.split(`
`).map(e=>e.trim()).filter(e=>e.length>0),m={name:f,scoringMode:r.value,rules:a.value.trim()||void 0,targetScore:o.value?parseInt(o.value,10):void 0,roundLabels:p.length>0?p:void 0,createdAt:Date.now()};try{c?(await t(parseInt(c,10),{name:m.name,scoringMode:m.scoringMode,rules:m.rules,targetScore:m.targetScore,roundLabels:m.roundLabels}),l(`Game updated`,`success`)):(await u(m),l(`${f} added!`,`success`)),this.games=await i(),this.editingGameId=null;let e=document.getElementById(`games-list`);e&&(e.innerHTML=this.renderGamesList());let n=document.getElementById(`add-game-form-container`);n&&(n.innerHTML=`<h3 class="card-title mb-3">Add Game</h3>${this.renderGameForm()}`),this.bindGameFormSubmit(),this.bindGameForm()}catch(e){console.error(e),l(`Failed to save game`,`error`)}})}bindSyncForm(){let e=this.syncConfig?.provider??`github`,t=t=>{e=t,document.querySelectorAll(`.provider-btn`).forEach(e=>{let n=e.dataset.provider===t;e.classList.toggle(`active`,n),e.setAttribute(`aria-pressed`,String(n))});let n=document.getElementById(`sync-baseurl-group`);n&&(n.style.display=t===`gitea`?`block`:`none`);let r=document.getElementById(`sync-pat-label`),i=document.getElementById(`sync-pat`),a=document.getElementById(`sync-pat-hint`);r&&(r.textContent=t===`gitea`?`API Key`:`Personal Access Token`),i&&(i.placeholder=t===`gitea`?`your-api-key`:`ghp_xxxxxxxxxxxxxxxxxxxx`),a&&(a.innerHTML=t===`gitea`?`Settings → Applications → Generate Token (needs repository read/write)`:`Needs <code>repo</code> scope`)};document.querySelectorAll(`.provider-btn`).forEach(e=>{e.addEventListener(`click`,()=>{t(e.dataset.provider)})});let n=()=>({provider:e,baseUrl:e===`gitea`?document.getElementById(`sync-baseurl`).value.trim().replace(/\/+$/,``):void 0,username:document.getElementById(`sync-username`).value.trim(),repo:document.getElementById(`sync-repo`).value.trim(),pat:document.getElementById(`sync-pat`).value.trim(),filePath:document.getElementById(`sync-filepath`).value.trim()||`scorekeeper.json`,branch:document.getElementById(`sync-branch`).value.trim()||`main`,lastSync:this.syncConfig?.lastSync}),r=e=>{let t=X(e);return t?(l(t,`error`),!1):!0};document.getElementById(`test-connection-btn`)?.addEventListener(`click`,async()=>{let e=n();if(!r(e))return;let t=document.getElementById(`test-connection-btn`);t.disabled=!0,t.textContent=`Testing…`;try{U(e),this.syncConfig=e;let t=await Z(e);l(t.message,t.ok?`success`:`error`)}finally{t.disabled=!1,t.textContent=`Test`}}),document.getElementById(`sync-to-github-btn`)?.addEventListener(`click`,async()=>{let e=n();if(!r(e))return;let t=document.getElementById(`sync-to-github-btn`);t.disabled=!0,t.textContent=`Pushing…`;try{U(e),this.syncConfig=e;let t=await Q(e);if(l(t.message,t.ok?`success`:`error`),t.ok){this.syncConfig=H();let e=document.getElementById(`last-sync-time`);e&&(e.textContent=this.formatTimestamp(this.syncConfig?.lastSync))}}finally{t.disabled=!1,t.textContent=`↑ Push`}}),document.getElementById(`sync-from-github-btn`)?.addEventListener(`click`,async()=>{let e=n();if(!r(e))return;let t=document.getElementById(`sync-from-github-btn`);t.disabled=!0,t.textContent=`Pulling…`;try{U(e),this.syncConfig=e;let t=e.provider===`gitea`?`Gitea`:`GitHub`,n=await $(e,async()=>confirm(`Local data exists. Overwrite with ${t} data? This cannot be undone.`));if(l(n.message,n.ok?`success`:`error`),n.ok){this.syncConfig=H();let e=document.getElementById(`last-sync-time`);e&&(e.textContent=this.formatTimestamp(this.syncConfig?.lastSync)),await this.load();let t=document.getElementById(`players-list`);t&&(t.innerHTML=this.renderPlayersList());let n=document.getElementById(`games-list`);n&&(n.innerHTML=this.renderGamesList()),this.bindPlayerForm(),this.bindGameForm()}}finally{t.disabled=!1,t.textContent=`↓ Pull`}})}bindDataButtons(){document.getElementById(`export-btn`)?.addEventListener(`click`,async()=>{try{let e=await x(),t=JSON.stringify(e,null,2),n=new Blob([t],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`scorekeeper-export-${new Date().toISOString().split(`T`)[0]}.json`,i.click(),URL.revokeObjectURL(r),l(`Data exported!`,`success`)}catch{l(`Export failed`,`error`)}}),document.getElementById(`import-btn`)?.addEventListener(`click`,()=>{document.getElementById(`import-file-input`)?.click()}),document.getElementById(`import-file-input`)?.addEventListener(`change`,async e=>{let t=e.target.files?.[0];if(t&&confirm(`Import will replace ALL current data. Continue?`))try{let e=await t.text();await r(JSON.parse(e)),l(`Data imported successfully!`,`success`),await this.load();let n=document.getElementById(`view-container`);n&&(n.innerHTML=this.render(),this.afterRender())}catch(e){console.error(e),l(`Import failed — invalid JSON`,`error`)}}),document.getElementById(`import-external-btn`)?.addEventListener(`click`,()=>{document.getElementById(`import-external-file-input`)?.click()}),document.getElementById(`import-external-file-input`)?.addEventListener(`change`,async e=>{let t=e.target.files?.[0];if(t)try{let e=await t.text(),n=await B(JSON.parse(e)),r=n.newPlayers.length>0?` (${n.newPlayers.length} new player${n.newPlayers.length>1?`s`:``}: ${n.newPlayers.join(`, `)})`:``;l(`Imported ${n.gameName} on ${n.date}: ${n.playerCount} players, ${n.roundCount} rounds${r}`,`success`),await this.load();let i=document.getElementById(`players-list`);i&&(i.innerHTML=this.renderPlayersList());let a=document.getElementById(`games-list`);a&&(a.innerHTML=this.renderGamesList()),this.bindPlayerForm(),this.bindGameForm()}catch(e){console.error(e),l(`Import failed — check the file format`,`error`)}finally{e.target.value=``}}),document.getElementById(`clear-data-btn`)?.addEventListener(`click`,async()=>{if(confirm(`Clear ALL data? This permanently deletes all players, games, nights, and scores. This CANNOT be undone.`)&&confirm(`Are you absolutely sure? All data will be lost forever.`))try{await S.transaction(`rw`,[S.players,S.games,S.gameNights,S.matches,S.scoreEntries],async()=>{await S.players.clear(),await S.games.clear(),await S.gameNights.clear(),await S.matches.clear(),await S.scoreEntries.clear()}),l(`All data cleared`,`info`),window.location.reload()}catch{l(`Failed to clear data`,`error`)}})}bindThemeToggle(){let e=document.getElementById(`theme-toggle`);e?.addEventListener(`change`,()=>{let t=e.checked,n=t?`dark`:`light`;document.documentElement.setAttribute(`data-theme`,n),localStorage.setItem(`theme`,n),e.setAttribute(`aria-checked`,String(t))})}};export{ee as Settings,N as t};