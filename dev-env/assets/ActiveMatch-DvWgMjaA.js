        ...
        `}else if(t===`finish-order`)f=`
          ...
          <div class="flex items-center gap-3 mb-2">
            ...
            <select class="form-select" style="max-width:120px; min-height:42px"
              id="score-input-${e.id}" data-player-id="${e.id}" aria-label="${u(e.displayName)} position">
