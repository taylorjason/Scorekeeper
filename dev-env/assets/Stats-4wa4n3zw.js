import{d as e,y as t}from"./index-DBwkVGqf.js";import{n}from"./utils-BZltm_RL.js";import{n as r,r as i,t as a}from"./stats-B4tkVPDE.js";var o=class{players=[];games=[];selectedPlayerId=null;leaderboard=[];playerStats=null;async load(){let[e,n,a]=await Promise.all([t.players.toArray(),t.games.toArray(),r()]);this.players=e.filter(e=>e.active),this.games=n,this.leaderboard=a,this.selectedPlayerId===null&&this.players.length>0&&(this.selectedPlayerId=this.players[0].id),this.selectedPlayerId!==null&&(this.playerStats=await i(this.selectedPlayerId))}render(){let e=this.players.map(e=>`
