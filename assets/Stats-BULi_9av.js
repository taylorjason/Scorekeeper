var p=Object.defineProperty;var v=(d,t,a)=>t in d?p(d,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):d[t]=a;var c=(d,t,a)=>v(d,typeof t!="symbol"?t+"":t,a);import{h as b,_ as g}from"./index-CiAI0UP5.js";import{c as u,a as y,b as $}from"./stats-BkqD8Yb-.js";class P{constructor(){c(this,"players",[]);c(this,"games",[]);c(this,"selectedPlayerId",null);c(this,"leaderboard",[]);c(this,"playerStats",null)}async load(){const[t,a,l]=await Promise.all([b.players.toArray(),b.games.toArray(),u()]);this.players=t.filter(i=>i.active),this.games=a,this.leaderboard=l,this.selectedPlayerId===null&&this.players.length>0&&(this.selectedPlayerId=this.players[0].id),this.selectedPlayerId!==null&&(this.playerStats=await y(this.selectedPlayerId))}escHtml(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}render(){const t=this.players.map(e=>`
