import{D as e,T as t,p as n}from"./index-vN90WraJ.js";import{n as r}from"./utils-BZltm_RL.js";import{n as i}from"./stats-f_owQcaR.js";var a=class{gameNights=[];leaderboard=[];activeMatch;async load(){let[n,r,a]=await Promise.all([e(),i(),t()]);this.gameNights=n.slice(0,3),this.leaderboard=r.slice(0,5),this.activeMatch=a}formatDate(e){let t=new Date(e+`T00:00:00`),n=Math.floor((new Date().getTime()-t.getTime())/864e5);return n===0?`Today`:n===1?`Yesterday`:n<7?`${n} days ago`:t.toLocaleDateString(`en-US`,{month:`short`,day:`numeric`,year:n>365?`numeric`:void 0})}rankIcon(e){return e===1?`🥇`:e===2?`🥈`:e===3?`🥉`:`<span class="rank-number">${e}</span>`}render(){let e=new Date().toLocaleDateString(`en-US`,{weekday:`long`,month:`long`,day:`numeric`}),t=``;this.activeMatch&&(t=`
