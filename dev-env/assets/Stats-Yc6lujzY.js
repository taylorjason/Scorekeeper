import{b as e,d as t}from"./index-3xWVDVA5.js";import{n,r,t as i}from"./stats-D498EAlC.js";var a=class{players=[];games=[];selectedPlayerId=null;leaderboard=[];playerStats=null;async load(){let[t,i,a]=await Promise.all([e.players.toArray(),e.games.toArray(),n()]);this.players=t.filter(e=>e.active),this.games=i,this.leaderboard=a,this.selectedPlayerId===null&&this.players.length>0&&(this.selectedPlayerId=this.players[0].id),this.selectedPlayerId!==null&&(this.playerStats=await r(this.selectedPlayerId))}escHtml(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}render(){let e=this.players.map(e=>`
    ...
    `}async afterRender(){this.playerStats&&this.playerStats.gameBreakdown.length>0&&await this.renderWinsChart(),this.playerStats&&this.playerStats.scoreTrend.length>1&&await this.renderTrendChart();for(let e of this.games)this.loadGameStats(e);document.querySelectorAll(`[data-player-id]`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=parseInt(e.dataset.playerId??``,10);isNaN(t)||(this.selectedPlayerId=t,this.playerStats=await r(t),this.reRender())})})}async loadGameStats(e){try{let t=await i(e.id),n=document.getElementById(`game-match-count-${e.id}`);n&&(n.textContent=`${t.totalMatches} match${t.totalMatches===1?``:`es`}`)}catch{}}async renderWinsChart(){let e=document.getElementById(`wins-bar-chart`);if(!(!e||!this.playerStats))try{let{Chart:n,registerables:r}=await t(async()=>{let{Chart:e,registerables:t}=await import(`./chart-vM59ydkj.js`);return{Chart:e,registerables:t}},[],import.meta.url);n.register(...r);let i=this.playerStats.gameBreakdown.map(e=>e.gameName),a=this.playerStats.gameBreakdown.map(e=>e.wins),o=this.playerStats.gameBreakdown.map(e=>e.losses),s=document.documentElement.getAttribute(`data-theme`)!==`light`,c=s?`#94a3b8`:`#64748b`,l=s?`rgba(255,255,255,0.05)`:`rgba(0,0,0,0.05)`;new n(e,{type:`bar`,data:{labels:i,datasets:[{label:`Wins`,data:a,backgroundColor:`rgba(16, 185, 129, 0.7)`,borderColor:`#10b981`,borderWidth:1,borderRadius:6},{label:`Losses`,data:o,backgroundColor:`rgba(239, 68, 68, 0.5)`,borderColor:`#ef4444`,borderWidth:1,borderRadius:6}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:c,font:{size:12}}}},scales:{x:{ticks:{color:c},grid:{color:l}},y:{beginAtZero:!0,ticks:{color:c,stepSize:1},grid:{color:l}}}}})}catch(e){console.warn(`Chart.js failed to load:`,e)}}async renderTrendChart(){let e=document.getElementById(`score-line-chart`);if(!(!e||!this.playerStats))try{let{Chart:n,registerables:r}=await t(async()=>{let{Chart:e,registerables:t}=await import(`./chart-vM59ydkj.js`);return{Chart:e,registerables:t}},[],import.meta.url);n.register(...r);let i=this.playerStats.scoreTrend,a=i.map((e,t)=>`Match ${t+1}`),o=i.map(e=>e.total),s=document.documentElement.getAttribute(`data-theme`)!==`light`,c=s?`#94a3b8`:`#64748b`,l=s?`rgba(255,255,255,0.05)`:`rgba(0,0,0,0.05)`;new n(e,{type:`line`,data:{labels:a,datasets:[{label:`Score`,data:o,borderColor:`#6366f1`,backgroundColor:`rgba(99, 102, 241, 0.15)`,borderWidth:2,pointBackgroundColor:`#6366f1`,pointRadius:4,fill:!0,tension:.3}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{ticks:{color:c},grid:{color:l}},y:{ticks:{color:c},grid:{color:l}}}}})}catch(e){console.warn(`Chart.js failed to load:`,e)}}reRender(){let e=document.getElementById(`view-container`);e&&(e.innerHTML=this.render(),this.afterRender())}};export{a as Stats};