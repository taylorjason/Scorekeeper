            ...
            <div class="card">
              <div class="text-sm" style="display:flex;flex-direction:column;gap:0.4rem">
                ...
                <div class="flex items-center gap-2">
                  ...
                  <span class="font-semibold">${new Date(`2026-06-10T04:19:14.269Z`).toLocaleString()}</span>
                </div>
              </div>
            </div>
          </section>
