import{d as e,f as t,y as n}from"./index-B-oC1RF8.js";import{n as r,r as i}from"./utils-BZltm_RL.js";import{n as a,r as o,t as s}from"./stats-DKT0DYj3.js";import{a as c,c as l,i as u,l as d,n as f,o as p,r as m,s as h}from"./query-engine-Ce40HYjb.js";var g=`scorekeeper_custom_stats`,_=`scorekeeper_claude_api_key`;function v(){try{return JSON.parse(localStorage.getItem(g)??`[]`)}catch{return[]}}function y(e){localStorage.setItem(g,JSON.stringify(e))}function b(){return localStorage.getItem(_)??``}function x(e){e?localStorage.setItem(_,e):localStorage.removeItem(_)}var S=`You are a JavaScript code generator for a board game scorekeeper app.
